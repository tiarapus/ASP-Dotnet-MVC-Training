$(function() {
	...
	gradient.addColorStop(1, '#4d79f5');
	new Chart(ctx3, {
		type: 'bar',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
	...
	new Chart(ctx4, {
		...
		data: {
			...
			datasets: [{
				label: '# of Votes',
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: ['#3bb001', '#4d79f5', '#8500ff', '#f10075', '#ffc107', '#3db4ec']
			}]
		},
		options: {
			maintainAspectRatio: false,
	...
	var datapie = {
		...
		datasets: [{
			data: [35,24,20,15,8],
			backgroundColor: ['#3bb001', '#4d79f5', '#8500ff', '#f10075', '#ffc107']
		}]
	};
	var optionpie = {
		maintainAspectRatio: false,
